package com.kotlin.lib.widget.refresh
...
class RefreshLayoutWrapper(
    ...
    private val startPageIndex = MVVMConfig.globalConfig.getStartPageIndex()
     ...
     * 一页的条目，默认16
     */
    override var pageSize = MVVMConfig.globalConfig.getPageSize()
